...
import styles from '../../styles/RentcarStyles/Nav.module.css'; // Fixed import path
    ...
    <nav className={styles.navbar}>
      <div className={styles['navbar-container']}>
        ...
        <div className={styles['nav-menu']}>
          ...
          <Link to='/rent' className={styles['nav-link']}>Rent A Car<div className={styles['circle']}/></Link>
