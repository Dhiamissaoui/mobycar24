    ...
    <section className={Styles['most-wanted-section']}>
      <div className={Styles['header-container']}>
        <div className={Styles['header-content']}>
          ...
          <p className={Styles['description']}>Lorem ipsum dolor sit amet consectetur. Adipiscing morbi tellus arcu sed morbi. Nibh amet dignissim in ac duis etiam consectetur dolor ultrices. Commodo risus egestas hendrerit morbi mattis ut vitae arcu.</p>
        </div>
      </div>
